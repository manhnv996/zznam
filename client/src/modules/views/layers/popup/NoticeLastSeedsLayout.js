...
//
    ...
    initMsgContent: function () {
        ...
        var nextmsgContent  = new cc.LabelBMFont("Bạn có muốn sử dụng không?", res.FONT_OUTLINE_30);
        nextmsgContent.setBoundingWidth(this._bg.width * 4 /5);
        nextmsgContent.setPosition(cc.p(this._bg.width / 2, this._bg.height * 2 / 3 - this.msgContent.height));

        this._bg.addChild(this.msgContent);
        this._bg.addChild(nextmsgContent);
    },
