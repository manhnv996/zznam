...
public class DataHandler {
    ...
    public static void setCache(String key, DataModel dbObject) throws Exception {
        DataController.getController().setCache(PREFIX + key, Constant.CACHE_EXP_TIME, dbObject);
    }

    public static void setCache(String key, Object obj) throws Exception {
        DataController.getController().setCache(PREFIX + key, Constant.CACHE_EXP_TIME, obj);
    }
